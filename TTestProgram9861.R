...
base <- read.csv("C:/Users/Shixt/OneDrive/Desktop/INTERNFILES2/rnaseq_donor9861/9861TPmBrainRegionBase.csv")
...
tests1 <- c()
logDiff1 <- rnorm(20696)
for(i in 1:nrow(angComp)){
  if(i%%1000 == 0){
    cat(i, "\n")
  }
  tests1 <- c(tests1, t.test(angComp[i,2:9],angComp[i,10:ncol(angComp)])$p.value)
}
for(i in 1:nrow(angComp)){
  if(i%%100 == 0){
    cat(i, "\n")
  }
  if(rowMeans(angComp[i,2:9])==0){
  logDiff1[i] <- log(1e-20/rowMeans(angComp[10:ncol(angComp)]))
  }else{
    logDiff1[i] <- log(rowMeans(angComp[i,2:9])/rowMeans(angComp[10:ncol(angComp)]))
  }
}
data1 <- data.frame(base$X, logDiff1, tests1)
write.csv(data1, "C:/Users/Shixt/OneDrive/Desktop/INTERNFILES2/angdata")



#BCd 2 3
bcdComp <- data.frame(base)
bcdComp <- bcdComp %>% relocate(contains("BCd"), .after = X)
tests2 <- c()
logDiff2 <- rnorm(20696)
for(i in 1:nrow(bcdComp)){
  if(i%%1000 == 0){
    cat(i, "\n")
  }
  tests2 <- c(tests2, t.test(bcdComp[i,2:3],bcdComp[i,4:ncol(angComp)])$p.value)
}
for(i in 1:nrow(angComp)){
  if(i%%100 == 0){
    cat(i, "\n")
  }
  if(rowMeans(bcdComp[i,2:3])==0){
    logDiff2[i] <- log(1e-20/rowMeans(bcdComp[4:ncol(bcdComp)]))
  }else{
    logDiff2[i] <- log(rowMeans(bcdComp[i,2:9])/rowMeans(bcdComp[10:ncol(angComp)]))
  }
}
data2 <- data.frame(base$X, logDiff2, tests2)
write.csv(data2, "C:/Users/Shixt/OneDrive/Desktop/INTERNFILES2/bcdData")
...
for(i in 1:nrow(angComp)){
  ...
  if(rowMeans(cggComp[i,2:5])==0){
    logDiff3[i] <- log(1e-20/rowMeans(bcdComp[6:ncol(bcdComp)]))
  }else{
...
tests4 <- c()
logDiff4 <- rnorm(20696)
for(i in 1:nrow(bcdComp)){
  if(i%%1000 == 0){
    cat(i, "\n")
  }
  tests4 <- c(tests4, t.test(cunComp[i,2:3],cunComp[i,4:ncol(angComp)])$p.value)
}
for(i in 1:nrow(angComp)){
  if(i%%100 == 0){
    cat(i, "\n")
  }
  if(rowMeans(cunComp[i,2:3])==0){
    logDiff4[i] <- log(1e-20/rowMeans(bcdComp[4:ncol(bcdComp)]))
  }else{
    logDiff4[i] <- log(rowMeans(cunComp[i,2:3])/rowMeans(cunComp[4:ncol(angComp)]))
  }
}
...
for(i in 1:nrow(angComp)){
  ...
  if(rowMeans(gpComp[i,2:5])==0){
    logDiff6[i] <- log(1e-20/rowMeans(gpComp[6:ncol(bcdComp)]))
  }else{
...
for(i in 1:nrow(angComp)){
  ...
  if(rowMeans(greComp[i,2:5])==0){
    logDiff7[i] <- log(1e-20/rowMeans(greComp[6:ncol(bcdComp)]))
  }else{
...
tests8 <- c()
logDiff8 <- rnorm(20696)
for(i in 1:nrow(bcdComp)){
  if(i%%1000 == 0){
    cat(i, "\n")
  }
  tests8 <- c(tests8, t.test(hcdComp[i,2:3],hcdComp[i,4:ncol(angComp)])$p.value)
}
for(i in 1:nrow(angComp)){
  if(i%%100 == 0){
    cat(i, "\n")
  }
  if(rowMeans(hcdComp[i,2:3])==0){
    logDiff8[i] <- log(1e-20/rowMeans(hcdComp[4:ncol(bcdComp)]))
  }else{
    logDiff8[i] <- log(rowMeans(hcdComp[i,2:3])/rowMeans(hcdComp[4:ncol(angComp)]))
  }
}
...
tests9 <- c()
logDiff9 <- rnorm(20696)
for(i in 1:nrow(bcdComp)){
  if(i%%1000 == 0){
    cat(i, "\n")
  }
  tests9 <- c(tests9, t.test(hemComp[i,2:4],hemComp[i,5:ncol(angComp)])$p.value)
}
for(i in 1:nrow(angComp)){
  if(i%%100 == 0){
    cat(i, "\n")
  }
  if(rowMeans(greComp[i,2:4])==0){
    logDiff9[i] <- log(1e-20/rowMeans(hemComp[5:ncol(bcdComp)]))
  }else{
    logDiff9[i] <- log(rowMeans(hemComp[i,2:4])/rowMeans(hemComp[5:ncol(angComp)]))
  }
}
...
for(i in 1:nrow(angComp)){
  ...
  if(rowMeans(itgComp[i,2:5])==0){
    logDiff10[i] <- log(1e-20/rowMeans(itgComp[6:ncol(bcdComp)]))
  }else{
...
for(i in 1:nrow(angComp)){
  ...
  if(rowMeans(ligComp[i,2:3])==0){
    logDiff11[i] <- log(1e-20/rowMeans(ligComp[4:ncol(bcdComp)]))
  }else{
...
for(i in 1:nrow(bcdComp)){
  ...
  tests11 <- c(tests11, t.test(ligComp[i,2:5],ligComp[i,6:ncol(angComp)])$p.value)
}
for(i in 1:nrow(angComp)){
  if(i%%100 == 0){
    cat(i, "\n")
  ...
  if(rowMeans(ligComp[i,2:5])==0){
    logDiff11[i] <- log(1e-20/rowMeans(ligComp[6:ncol(bcdComp)]))
  }else{
    logDiff11[i] <- log(rowMeans(ligComp[i,2:5])/rowMeans(ligComp[6:ncol(angComp)]))
  }
}
data11 <- data.frame(base$X, logDiff11, tests11)
write.csv(data11, "C:/Users/Shixt/OneDrive/Desktop/INTERNFILES2/ligData")
...
#LOrG 2 3
logComp <- data.frame(base)
logComp <- logComp %>% relocate(contains("LOrG"), .after = X)
tests13 <- c()
logDiff13 <- rnorm(20696)
for(i in 1:nrow(bcdComp)){
  if(i%%1000 == 0){
    cat(i, "\n")
  }
  tests13 <- c(tests13, t.test(logComp[i,2:3],logComp[i,4:ncol(angComp)])$p.value)
}
for(i in 1:nrow(angComp)){
  if(i%%100 == 0){
    cat(i, "\n")
  }
  if(rowMeans(logComp[i,2:3])==0){
    logDiff13[i] <- log(1e-20/rowMeans(logComp[4:ncol(bcdComp)]))
  }else{
    logDiff13[i] <- log(rowMeans(logComp[i,2:3])/rowMeans(logComp[4:ncol(angComp)]))
  }
}
data13 <- data.frame(base$X, logDiff13, tests13)
write.csv(data13, "C:/Users/Shixt/OneDrive/Desktop/INTERNFILES2/logData")

#MFG 2 5
mfgComp <- data.frame(base)
mfgComp <- mfgComp %>% relocate(contains("MFG"), .after = X)
tests14 <- c()
logDiff14 <- rnorm(20696)
for(i in 1:nrow(bcdComp)){
  if(i%%1000 == 0){
    cat(i, "\n")
  }
...
for(i in 1:nrow(angComp)){
  ...
  if(rowMeans(mfgComp[i,2:5])==0){
    logDiff14[i] <- log(1e-20/rowMeans(mfgComp[6:ncol(bcdComp)]))
  }else{
...
for(i in 1:nrow(angComp)){
  ...
  if(rowMeans(mogComp[i,2:4])==0){
    logDiff15[i] <- log(1e-20/rowMeans(mogComp[5:ncol(bcdComp)]))
  }else{
...
for(i in 1:nrow(angComp)){
  ...
  if(rowMeans(mtgComp[i,2:5])==0){
    logDiff16[i] <- log(1e-20/rowMeans(mtgComp[6:ncol(bcdComp)]))
  }else{
...
tests17 <- c()
logDiff17 <- rnorm(20696)
for(i in 1:nrow(bcdComp)){
  if(i%%1000 == 0){
    cat(i, "\n")
  }
  tests17 <- c(tests17, t.test(ifgComp[i,2:6],ifgComp[i,7:ncol(angComp)])$p.value)
}
for(i in 1:nrow(angComp)){
  if(i%%100 == 0){
    cat(i, "\n")
  }
  if(rowMeans(ifgComp[i,2:6])==0){
    logDiff17[i] <- log(1e-20/rowMeans(ifgComp[7:ncol(bcdComp)]))
  }else{
    logDiff17[i] <- log(rowMeans(ifgComp[i,2:6])/rowMeans(ifgComp[7:ncol(angComp)]))
  }
}
...
for(i in 1:nrow(angComp)){
  ...
  if(rowMeans(pclComp[i,2:10])==0){
    logDiff18[i] <- log(1e-20/rowMeans(pclComp[11:ncol(bcdComp)]))
  }else{
...
for(i in 1:nrow(angComp)){
  ...
  if(rowMeans(pcuComp[i,2:5])==0){
    logDiff19[i] <- log(1e-20/rowMeans(pcuComp[6:ncol(bcdComp)]))
  }else{
...
for(i in 1:nrow(angComp)){
  ...
  if(rowMeans(phgComp[i,2:5])==0){
    logDiff20[i] <- log(1e-20/rowMeans(phgComp[6:ncol(bcdComp)]))
  }else{
...
tests21 <- c()
logDiff21 <- rnorm(20696)
for(i in 1:nrow(bcdComp)){
  if(i%%1000 == 0){
    cat(i, "\n")
  }
  tests22 <- c(tests22, t.test(pogComp[i,2:9],pogComp[i,10:ncol(angComp)])$p.value)
}
for(i in 1:nrow(angComp)){
  if(i%%100 == 0){
    cat(i, "\n")
  ...
  if(rowMeans(pogComp[i,2:9])==0){
    logDiff21[i] <- log(1e-20/rowMeans(pogComp[10:ncol(bcdComp)]))
  }else{
...
for(i in 1:nrow(angComp)){
  ...
  if(rowMeans(prgComp[i,2:5])==0){
    logDiff22[i] <- log(1e-20/rowMeans(prgComp[6:ncol(bcdComp)]))
  }else{
...
tests23 <- c()
logDiff23 <- rnorm(20696)
for(i in 1:nrow(bcdComp)){
  if(i%%1000 == 0){
    cat(i, "\n")
  }
  tests23 <- c(tests23, t.test(puComp[i,2:6],puComp[i,7:ncol(angComp)])$p.value)
}
for(i in 1:nrow(angComp)){
  if(i%%100 == 0){
    cat(i, "\n")
  }
  if(rowMeans(puComp[i,2:6])==0){
    logDiff23[i] <- log(1e-20/rowMeans(puComp[7:ncol(bcdComp)]))
  }else{
    logDiff23[i] <- log(rowMeans(puComp[i,2:6])/rowMeans(puComp[7:ncol(angComp)]))
  }
}
...
for(i in 1:nrow(angComp)){
  ...
  if(rowMeans(sfgComp[i,2:9])==0){
    logDiff25[i] <- log(1e-20/rowMeans(phgComp[10:ncol(bcdComp)]))
  }else{
...
for(i in 1:nrow(angComp)){
  ...
  if(rowMeans(sigComp[i,2:3])==0){
    logDiff26[i] <- log(1e-20/rowMeans(sigComp[4:ncol(bcdComp)]))
  }else{
...
for(i in 1:nrow(angComp)){
  ...
  if(rowMeans(smgComp[i,2:5])==0){
    logDiff27[i] <- log(1e-20/rowMeans(smgComp[6:ncol(bcdComp)]))
  }else{
...
tests28 <- c()
logDiff28 <- rnorm(20696)
for(i in 1:nrow(bcdComp)){
  if(i%%1000 == 0){
    cat(i, "\n")
  }
  tests28 <- c(tests28, t.test(splComp[i,2:5],splComp[i,6:ncol(angComp)])$p.value)
}
for(i in 1:nrow(angComp)){
  if(i%%100 == 0){
    cat(i, "\n")
  }
  if(rowMeans(splComp[i,2:5])==0){
    logDiff28[i] <- log(1e-20/rowMeans(splComp[6:ncol(bcdComp)]))
  }else{
    logDiff28[i] <- log(rowMeans(splComp[i,2:5])/rowMeans(splComp[6:ncol(angComp)]))
  }
}
...
for(i in 1:nrow(angComp)){
  ...
  if(rowMeans(stgComp[i,2:5])==0){
    logDiff29[i] <- log(1e-20/rowMeans(stgComp[6:ncol(bcdComp)]))
  }else{
